...
def train_model(
    ...
    train_dataset = ReceiptCollageDataset(train_csv, train_dir)
    train_loader = DataLoader(
        train_dataset, batch_size=batch_size, shuffle=True, num_workers=4
    )

    if val_csv and val_dir:
        val_dataset = ReceiptCollageDataset(val_csv, val_dir)
    ...
    print("Initialized Swin-Tiny model for receipt counting (classification)")
    ...
    for epoch in range(epochs):
        ...
        if val_balanced_acc > best_balanced_acc:
            ...
            model.save(os.path.join(output_dir, "receipt_counter_swin_best.pth"))
    ...
    # Save final model
    model.save(os.path.join(output_dir, "receipt_counter_swin_final.pth"))
