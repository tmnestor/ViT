...
from train_swin_counter import ReceiptCollageDataset, validate

def evaluate_model(model_path, test_csv, test_dir, batch_size=16, output_dir="evaluation"):
    """
    ...
    plt.title('Predicted vs Actual Receipt Counts')
    ...
    plt.title('Mean Absolute Error by Receipt Count')
